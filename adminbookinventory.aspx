            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img id="imgView" height="100" width="100" src="book_inventory/b1.jpg" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                     ...
                     <div class="col-md-3">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:LinkButton class="btn btn-primary" OnClick="btnBookID_Click" ID="btnBookID" runat="server"><i class="fas fa-check-circle"></i></asp:LinkButton>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-9">
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="ddlPublisherList" runat="server">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="ddlAuthorList" runat="server">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="txtPubDate" runat="server" placeholder="Date" TextMode="Date"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-4">
                        <label>Genre</label>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="txtCost" runat="server" placeholder="Book Cost(per unit)" TextMode="Number"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-4">
                        <label>Pages</label>
                  ...
                  <div class="row">
                     <div class="col-12">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="txtDescription" runat="server" placeholder="Book Description" TextMode="MultiLine" Rows="2"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                   <br />
                   <center>
                      <div class="row mx-auto">
                         <div class="col-4">
                            <asp:Button ID="btnAdd" OnClick="btnAdd_Click" class="btn btn-lg btn-success" runat="server" Text="Add" />
                         </div>
                         <div class="col-4">
                            <asp:Button ID="btnUpdate" OnClick="btnUpdate_Click" class="btn btn-lg btn-warning" runat="server" Text="Update" />
                         </div>
                         <div class="col-4">
                            <asp:Button ID="btnDelete" OnClick="btnDelete_Click" class="btn btn-lg btn-danger" runat="server" Text="Delete" />
                         </div>
                      </div>
                    </center>
               </div>
